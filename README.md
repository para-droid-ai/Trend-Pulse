...
-   **Handling AI Reasoning/Thought Processes (`<think>` tags):**
    -   Summaries from Perplexity's reasoning models may include sections wrapped in `<think>...</think>` tags, detailing the AI's intermediate thought processes or reasoning steps.
    -   TrendPulse automatically identifies this "thought" content and initially hides it to maintain a clean and focused primary summary.
    -   Users can easily toggle the visibility of these hidden sections (e.g., via an "Expand Thoughts" button or similar UI element).
    -   This offers transparency into the AI's generation process, allowing for deeper insight without cluttering the main content.
    -   *[Screenshot illustrating thought process masking and expansion to be added by user]*
