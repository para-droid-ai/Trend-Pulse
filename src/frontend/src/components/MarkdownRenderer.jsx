...
export default function MarkdownRenderer({ content, sources = [] }) {
  ...
  return (
    <div 
      className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert prose-p:my-2 prose-h1:mt-3 prose-h1:mb-2 prose-h2:mt-3 prose-h2:mb-2 prose-h3:mt-2 prose-h3:mb-1 px-2"
    >
        ...
        section.type === 'think' ? (
          ...
          <ReactMarkdown
            ...
            components={{
              ...
              h3: ({node, children, ...props}) => <h2 {...props}>{children}</h2>,
              h4: ({node, children, ...props}) => <h2 {...props}>{children}</h2>,
              h5: ({node, children, ...props}) => <h2 {...props}>{children}</h2>,
              h6: ({node, children, ...props}) => <h2 {...props}>{children}</h2>,
