              ...
              <>
                {streams.map((stream, index) => {
                  ...
                  const showInsertionBefore =
                    dragInsertionIndex === index && draggedStreamId;
                  ...
                  return (
                    <div key={stream.id}>
                      ...
                      {showInsertionBefore && (
                        <div
                          className="h-0.5 bg-white rounded-full shadow-lg mx-4 mb-2 opacity-90
                      ...
                      >
                        ...
                        <div className="ml-6">
                          ...
                          <div className="flex items-start justify-between gap-2 mb-2">
                            <h3
                              className="font-medium text-foreground leading-tight line-clamp-2 text-sm
                          ...
                          <div className="flex items-center justify-between text-xs text-muted-foreground">
                            ...
                            <span
                              className={`${getStatusColor(status)} transition-colors duration-200 ease-[cubic-bezier(0.4,0.0,0.2,1)]`}
                            >
                ...
                {dragInsertionIndex === streams.length && draggedStreamId && (
                  <div
                    className="h-0.5 bg-white rounded-full shadow-lg mx-4 mt-2 opacity-90
                                animate-pulse transition-all duration-200 ease-[cubic-bezier(0.4,0.0,0.2,1)]"
                  >
                    <div className="h-full bg-gradient-to-r from-transparent via-white to-transparent"></div>
                  </div>
