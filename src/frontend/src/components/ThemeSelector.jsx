...
const ThemeSelector = ({ isOpen, onClose, onToggleRequest }) => {
  ...
  if (!isOpen && !onToggleRequest) return null;
  if (!isOpen && onToggleRequest) {
    return (
      <button
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <div className="relative">
                    ...
                    <div
                      className={`dot absolute left-1 top-1 bg-card w-4 h-4 rounded-full transition ${isDarkMode ? "transform translate-x-4" : ""}`}
                    ></div>
                  </div>
                ...
                {Object.entries(themes)
                  ...
                  .map(([themeKey, themeData]) => {
                    ...
                    const hasDarkVariant =
                      themes[`${themeKey}-dark`] !== undefined;
                    const hasLightVariant =
                      themes[`${themeKey}-light`] !== undefined;
                    ...
                    const isActive =
                      currentTheme === actualThemeKey ||
                      currentTheme.replace(/-light$|-dark$/, "") ===
                        themeKey.replace(/-light$|-dark$/, "");
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex space-x-1">
                            <div
                              ...
                              style={{
                                backgroundColor:
                                  actualThemeData.colors.background,
              ...
              <p className="text-sm text-muted-foreground text-center">
                {
                  Object.keys(themes).filter((key) => {
                    ...
                    return isDarkMode
                      ? !themes[key]?.isLightOnly
                      : !themes[key]?.isDarkOnly;
                  }).length
                }{" "}
                beautiful themes available • Your choice is automatically saved
              </p>
            </div>
          </div>
        </div>
