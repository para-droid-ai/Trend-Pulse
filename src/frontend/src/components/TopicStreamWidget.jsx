                ...
                <div key={summary.id} className="p-2 w-full overflow-hidden">
                  ...
                  <div className="px-2 py-1">
                    {summary.thoughts && (
                      <div className="not-prose my-4">
                        <MaskedSection label="Thoughts (experimental)">{summary.thoughts}</MaskedSection>
                      </div>
                    )}
                  ...
                  {summary.sources && summary.sources.length > 0 && (
                    <div className="px-2 pb-2 w-full overflow-hidden">
                      <div className="text-xs font-medium text-muted-foreground mb-1 w-full">Sources:</div>
                      ...
                      {(summary.prompt_tokens !== null || summary.completion_tokens !== null || summary.total_tokens !== null) && (
                        <div className="flex flex-wrap items-center gap-x-2 w-full overflow-hidden">
                          ...
                          {summary.completion_tokens !== null && (
                            <>
                              {summary.prompt_tokens !== null && <span className="text-muted-foreground/60 mx-1">|</span>}
                          ...
                          {summary.total_tokens !== null && (
                            <>
                              {(summary.prompt_tokens !== null || summary.completion_tokens !== null) && <span className="text-muted-foreground/60 mx-1">|</span>}
